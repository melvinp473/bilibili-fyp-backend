...
def create_app(debug=False):
    ...
    def run_machine_learning():
        ...
        test = mongo_db_function.get_by_query(collection, request_json, "DATASET_ID")
        path = mongo_db_function.list_to_csv(store)
        df = mongo_db_function.list_to_pd(test)
        ...
        try:
            ...
            if algo == "linear_regr":
                ...
                return_dict = classification.decision_trees_classification(df, path, target_variable, independent_variables, algo_params)
